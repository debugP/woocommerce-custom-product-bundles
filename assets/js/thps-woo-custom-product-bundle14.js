console.log("Script file loaded: thps-woo-custom-product-bundle14.js");

var bundleTotalPrice = 0;
var dialogBox; // Declare dialogBox here
...
function alertValidationError( dialogBox, errorField, message ){
    console.log("alertValidationError called"); // Added log
...
jQuery(document).ready(function($) {
    ...
    $('form.thps_product_bundle').on('submit', function(e) {
        ...
        if (selectedProducts < minProducts) {
            console.log("Validation failed: selectedProducts < minProducts"); // Added log
            console.log("Minimum products not met, triggering modal");
            e.preventDefault();
            // Use the integrated alertValidationError function
            alertValidationError(dialogBox, '', 'Please select at least ' + minProducts + ' products.');
            return false;
        }
