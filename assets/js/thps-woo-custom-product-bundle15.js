console.log("Script file loaded: thps-woo-custom-product-bundle15.js");

var bundleTotalPrice = 0;
// var dialogBox; // Commented out dialogBox
...
// Function to display validation errors in the modal - REMOVED
...
jQuery(document).ready(function($) {
    ...
    // Initialize the jQuery UI Dialog - REMOVED FROM HERE
    ...
    $('form.thps_product_bundle').on('submit', function(e) {
        ...
        if (selectedProducts < minProducts) {
            ...
            console.log("Minimum products not met, triggering alert");
            e.preventDefault();
            // Use a simple alert for debugging
